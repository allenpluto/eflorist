<div class="section_container form_container">
    ...
    <div class="section_content ajax_form_container">
        <form id="form_manager_web_page" class="ajax_form">
            ...
            <div class="form_row_container">
                <label for="form_manager_web_page_description">Description</label>
                <textarea id="form_manager_web_page_description" name="description" placeholder="Description">[[*description]]</textarea>
            </div>
            <div class="form_row_container">
                <label for="form_manager_web_page_meta_keywords">Meta Keywords</label>
                <input id="form_manager_web_page_meta_keywords" name="meta_keywords" type="text" placeholder="Meta Keywords" value="[[*meta_keywords]]">
            </div>
            <div class="form_row_container">
                <label for="form_manager_web_page_page_title">Body Title</label>
                <input id="form_manager_web_page_page_title" name="page_title" type="text" placeholder="Page Title" value="[[*page_title]]">
            </div>
            <div class="form_row_container">
                <label for="form_manager_web_page_page_content">Body Content</label>
                <textarea id="form_manager_web_page_page_content" name="page_content" type="text" placeholder="Page Content">[[*page_content]]</textarea>
            </div>
