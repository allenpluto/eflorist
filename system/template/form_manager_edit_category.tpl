<div class="section_container container form_container">
    ...
    <div class="section_content ajax_form_container">
        <form id="form_manager_category" class="ajax_form">
            ...
            <div class="form_row_container form_row_container_mandatory">
                <label for="form_manager_category_alternate_name">Category Code Name</label>
                <input id="form_manager_category_alternate_name" name="alternate_name" type="text" placeholder="Code Name" value="[[*alternate_name]]">
            </div>
            ...
            --><a href="[[*base]][[*control_panel]]/product/list_category" class="footer_action_button footer_action_button_back">Back</a><!--
